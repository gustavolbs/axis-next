...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerCapabilitiesGet]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.axisWorkHubGetSourceStatuses]: AuthOrchestrationReadScope,
  [WS_METHODS.providerWorkHubCollect]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScheduledActivitiesList]: AuthOrchestrationReadScope,
  [WS_METHODS.axisScheduledActivitiesCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScheduledActivitiesUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScheduledActivitiesDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScheduledActivitiesRunNow]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScheduledActivitiesListRuns]: AuthOrchestrationReadScope,
  [WS_METHODS.axisLearningGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.axisLearningRecordEvidence]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningCreateProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningSubmitProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningApproveProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningRejectProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningActivateVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningRollbackVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningDeactivateVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisLearningRequestImprovements]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisOnboardingList]: AuthOrchestrationReadScope,
  [WS_METHODS.axisOnboardingGet]: AuthOrchestrationReadScope,
  [WS_METHODS.axisOnboardingStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisOnboardingCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisOnboardingRetry]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisOnboardingApply]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisTasksList]: AuthOrchestrationReadScope,
  [WS_METHODS.axisTasksGet]: AuthOrchestrationReadScope,
  [WS_METHODS.axisTasksCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisTasksUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisTasksPause]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisTasksReopen]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.axisTaskFeedbackRecord]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisProjectProfileGet]: AuthOrchestrationReadScope,
  [WS_METHODS.axisProjectProfileReplace]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisProjectProfileResetOverride]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsList]: AuthOrchestrationReadScope,
  [WS_METHODS.axisScratchChatsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.axisScratchChatsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsPatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsArchive]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsRemove]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsSendMessage]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsInterrupt]: AuthOrchestrationOperateScope,
  [WS_METHODS.axisScratchChatsSubscribe]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.serverGetTokenEfficiency]: AuthOrchestrationReadScope,
