...
/**
 * RouteMux brand mark, from https://routemux.com/icon.svg. Self-contained
 * like the other vendor badges here: it carries its own dark plate rather
 * than inheriting the theme, because the mark is only legible on one.
 */
export const RouteMuxIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 2000 2000" className={cn("fill-none", className)}>
    <rect width="2000" height="2000" rx="437" fill="#171717" />
    <g transform="translate(200,200) scale(0.8)">
      <path
        fill="#fff"
        d="M 202.84,1449.04 c 63.63,-138.05 128.18,-275.66 191.91,-413.82 c 9.22,-17.04 18.15,-32.35 30.24,-47.67 c 49.13,-63.69 121.93,-105.36 201.54,-114.27 c 8.32,-0.87 16.64,-1.6 24.97,-2.19 c 73.33,0.04 146.67,0.01 220,-0.09 c 64.73,-4.29 103.21,-71.04 76.56,-129.43 c -16.47,-33.47 -48.71,-52.24 -85.56,-51.8 c -219.32,0 -438.64,0 -657.96,0 c -2.51,0.29 -1.88,-4.5 -0.83,-5.71 c 74.1,-74.24 148.15,-148.44 222.28,-222.58 c 0.66,-0.79 1.5,-1.22 2.53,-1.3 c 148.32,-0.03 296.65,-0.04 444.98,-0.03 c 9.49,0.27 28.74,0.54 36.94,3.2 c 54.42,8.6 101.67,29.6 144.39,64.56 c 43.28,36.03 74.45,81.11 92.55,134.39 c 14.63,44.06 18.91,87.94 12.9,134.2 c -0.48,13.6 -5.61,30.56 -9.16,44.03 c -29.85,99.76 -105.53,174.84 -205.63,203.2 c -13.36,3.46 -29.45,8.17 -42.98,8.58 c -10.36,1.38 -20.77,2.12 -31.22,2.21 c -57.59,0.04 -115.19,0.05 -172.79,0.03 c -37.05,-0.11 -66.05,17.7 -83.12,50.4 c -43.14,92.86 -86.27,185.74 -129.37,278.64 c -8.91,20.05 -19.02,40.08 -27.78,60.26 c -0.99,1.92 -2.03,3.81 -3.14,5.67 c -0.81,0.41 -1.67,0.58 -2.58,0.51 c -82.34,-0.01 -164.68,-0.01 -247.02,0.01 c -0.86,-0.04 -2.44,0.18 -2.65,-1 Z M 671.22,1123.21 c 83.38,-0.15 166.76,-0.11 250.13,0.11 c 0.44,0.14 0.83,0.38 1.15,0.72 c 23.6,25.07 47.14,50.21 70.59,75.42 c 21.07,21.76 47.07,30.08 76.93,23.11 c 13.69,-3.65 25.53,-10.49 35.52,-20.53 c 78.15,-83.51 156.37,-166.96 234.63,-250.37 c 60.03,-61.7 145.07,-90.12 230.33,-77.73 c 84.87,14.05 151.17,60.47 194,134.9 c 24.09,44.37 34.47,88.97 33.14,139.66 c -0.43,7.68 -0.96,15.34 -1.56,23 c 0.06,92.63 -0.01,185.25 -0.21,277.86 c -0.85,1.11 -2.17,0.5 -3.37,0.67 c -74.34,-0.01 -148.68,-0.01 -223.02,0 c -0.9,0.13 -1.69,-0.09 -2.35,-0.67 c -0.22,-92.28 -0.29,-184.57 -0.22,-276.86 c -1.08,-68.45 -83.47,-102.6 -132.45,-53.54 c -3.43,3.89 -7.01,7.65 -10.73,11.28 c -82.81,88.58 -165.68,177.11 -248.62,265.56 c -29.42,28.42 -61.77,46.83 -102.61,51.99 c -55.46,6.76 -108.23,-11.76 -146.87,-51.92 c -5.47,-6.2 -11.04,-12.32 -16.71,-18.34 c -78.55,-83.72 -157.06,-167.49 -235.54,-251.29 c -0.84,-0.93 -1.56,-1.94 -2.16,-3.03 Z"
      />
    </g>
  </svg>
);
