...
Axis publishes its own signed macOS releases through a separate, simpler path; see
[the Axis release guide](../axis/RELEASE.md) for the certificate, the update feed, and the
`release-axis-macos.yml` workflow.
